...
<img src="https://t3.ftcdn.net/jpg/02/20/14/38/240_F_220143804_fc4xRygvJ8bn8JPQumtHJieDN4ORNyjs.jpg"align="center"width="1000" height="200"/>
    <div  style="text-align: center">
        <h1 size="10" color=" black">Welcome,</h1>
        <b>(${user.uname})</b>
         <h1 size="30" color=" black">To Your Account</h1>
         <b>Username: (${user.uname})</b>
           <br><br>
         <b>Account No: (${user.accno})</b>
        <br><br>
