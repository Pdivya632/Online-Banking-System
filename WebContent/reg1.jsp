...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTaXamp_cjieKws5x1nqS6jmjVcVzrPL2ZqeTxrh2z1Dy_rZ3K-&usqp=CAU"align="center"width="300" height="200"/>
...
<td><font size="10" color="blue"><u>REGISTRATION PAGE:</font></b></i></u></br></br>
<form action="./regdata1" method="post">
Username: <input type="text" name="Username" required></br></br>
Account no:<input type="text" name="Accountno" required></br></br>
Password:<input type="Password" name="Password" required> </br></br>
Re-Password:<input type="Password" name="RePassword" required> </br></br>
Address: <input type="text" name="Address" required></br></br>
Ammount:<input type="text" name="Ammount" required></br></br>
