...
<td><font size="10" color="blue"><u>DEPOSIT FORM</font></b></i></u></br></br>
<form action="./deptdata" method="post">
UserName:<input type="text" name ="username" required></br></br>
Account No:<input type="account no" name="accountno"  required></br></br>
Password:<input type="password" name ="password" required> </br></br>
Amount:<input type="amount" name ="amount" required></br></br>
<button><a href="afterdeposit.html">Log In</button></a>&nbsp&nbsp&nbsp
<button>Clear</button>
</form>
</td>
<td><font size="7" color="blue"><b><u><i>Welcome</font></b></i></u></br></br>
<img src="https://t3.ftcdn.net/jpg/02/20/14/38/240_F_220143804_fc4xRygvJ8bn8JPQumtHJieDN4ORNyjs.jpg"align="center"width="500" height="300"/>
