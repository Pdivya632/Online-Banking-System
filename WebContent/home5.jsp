...
<p><marquee><font color="yellow" size="5">WELCOME</marquee></p></font>
</br></br>
...
<table border="4">
<tr>
<td><font size="8" color="blue"><u><b><i>Sevices</font></b></i></br></u></br>
...
<%
String thisname = (String) session.getAttribute("taccno");
String thisamount = (String) session.getAttribute("amount");
%>
<div>
<b>Hello , Mr/Mrs:${user.uname}</b>
<br/>
<b>You have transfered this amount Rs: <%= thisamount %> /-</b>
<b>To this  Account Number</b> <b><%= thisname %> </b> 
